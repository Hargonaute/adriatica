...
const DEFAULT_HEADING = "Newsletter";
const DEFAULT_BODY =
  "Restez informé sur les dernières nouveautés de Maghreb Adriatica!";
const DEFAULT_BUTTON_LABEL = "S'inscrire";
const DEFAULT_IMAGE_URL =
  "https://images.unsplash.com/photo-1500382017468-9049fed747ef?q=80&w=1200&auto=format&fit=crop";
const DEFAULT_IMAGE_ALT =
  "Beautiful farm field with green crops under a sunny sky";
...
export function NewsletterCTA({
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (!collection) {
        throw new Error(
          `Aucune collection "${collectionSlug}" n'est configurée.`
        );
      }
      ...
      if (!res.ok) throw new Error("Échec de l'inscription. Réessayez.");
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-8">
        ...
        <div className="bg-white rounded-[2rem] overflow-hidden flex flex-col-reverse lg:flex-row shadow-xl">
          ...
          <div className="flex-1 p-10 md:p-14 lg:p-16 xl:p-20 flex flex-col justify-center">
            ...
            <p className="text-slate-500 text-lg mb-10 max-w-md">{body}</p>
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  <div className="flex-1 flex flex-col gap-3">
                    ...
                    <p className="text-[10px] text-slate-500 leading-snug">
                      ...
                      <br />
                      personnelles aux termes du décret législatif
                      <br />
                      196/2003.
                    </p>
                    {error && (
