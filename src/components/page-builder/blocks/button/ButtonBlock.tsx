...
import { ArrowRight, ExternalLink, ArrowDownToLine } from 'lucide-react';

type Block = ButtonBlockData;
...
export function ButtonPreview({ block }: { block: Block }) {
  ...
  const IconEl =
    ...
    icon === 'external' ? <ExternalLink size={16} /> :
    icon === 'download' ? <ArrowDownToLine size={16} /> : null;
